...
to test indirect effects in a parallel
...
#| fig-cap: "A Parallel Mediation Model"
#| echo: false
#| fig-width: 6
#| fig-heigh: 3
#| fig-align: center
...
p <- semPaths(fit0,
              ...
              edge.color = c("black", "white", "white", "white", "white"),
              border.color = c("black", "white", "white", "black", "black"),
              label.color = c("black", "white", "white", "black", "black"),
              mar = c(5, 5, 5, 5),
              layout = layout_m,
              DoNotPlot = TRUE)
plot(p)
...
p <- semPaths(fit0,
              ...
              label.cex = 1.25,
              style = "ram",
              color = c("white", "lightblue", "white", "lightblue"),
              edge.color = c("white", "black", "white", "white", "white"),
              border.color = c("white", "black", "white", "black", "black"),
              label.color = c("white", "black", "white", "black", "black"),
              mar = c(5, 5, 5, 5),
              layout = layout_m,
              DoNotPlot = TRUE)
plot(p)
...
p <- semPaths(fit0,
              ...
              edge.color = c("white", "white", "black", "black", "black"),
              border.color = c("black", "black", "black", "black", "black"),
              label.color = c("black", "black", "black", "black", "black"),
              mar = c(5, 5, 5, 5),
              layout = layout_m,
              DoNotPlot = TRUE)
plot(p)
...
The 95% bootstrap confidence interval is
`r ci_str(ind1_stdxy)`, significant.
...
The 95% bootstrap confidence interval is
`r ci_str(ind2_stdxy)`, significant.
...
sample size (`r nrow(data_parallel)`).

The difference in standardized indirect
effects (`r coef_str(ind1_stdxy)` vs. `r coef_str(ind2_stdxy)`)
can be computed similarly:
...
#| fig-caption: "A Parallel Mediation Model With Control Variables"
#| echo: false
#| fig-width: 6
#| fig-heigh: 5
#| fig-align: center
...
`r coef_str(ind2_1)`.
The 95% bootstrap confidence interval is
`r ci_str(ind2_1)`, slightly decreased after the
...
`r coef_str(ind2_2)`.
The 95% bootstrap confidence interval is
`r ci_str(ind2_2)`, decreased after the
control variables are included, but
still significant.
...
Although control variables predict
...
#| fig-caption: "A Parallel Mediation Model With Some Paths Omitted"
#| echo: false
#| fig-width: 6
#| fig-heigh: 5
#| fig-align: center
...
Then the indirect effects can be computed
as before.
...
is `r nrow(data_parallel_listwise)`, less than
the full sample with missing data
(`r nrow(data_parallel_listwise)`).
...
the source file](https://github.com/blogonresearch/blogonresearch.github.io/commits/main/posts/manymome_parallel_mediation/index.qmd).
